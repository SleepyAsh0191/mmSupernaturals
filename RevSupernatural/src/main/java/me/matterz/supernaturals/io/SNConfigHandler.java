...
public class SNConfigHandler {
	...
	public static HashSet<Material> transparent = new HashSet<Material>();
	...
	public static void loadValues(Configuration config) {
		...
		priestChurchLocation = new Location(plugin.getServer().getWorld(priestChurchWorld), priestChurchLocationX,
				priestChurchLocationY, priestChurchLocationZ);
		priestBanishLocation = new Location(plugin.getServer().getWorld(priestBanishWorld), priestBanishLocationX,
